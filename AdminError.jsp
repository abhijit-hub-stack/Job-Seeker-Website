<%-- 
    Document   : AdminError
    Created on : 27 Feb 2025, 9:21:03 am
    Author     : user
--%>
...
<html>
    ...
    <body>
        ...
        <h1>Your Registration is Failed</h1>

        <!-- Error message description -->
        <div class="message">
            Something went wrong during your registration. Please try again.
        </div>

        <!-- Optional link to go back to registration page -->
        <a href="AdminRegister.jsp">Go back to Registration</a>
    </div>
    </body>
</html>
